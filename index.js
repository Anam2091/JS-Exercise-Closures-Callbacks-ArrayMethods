...
function stringSmash(strings) {
  ...
  let results = strings.reduce(reducer)  
  return results
  }
...
function getFullNames(runners) {
  let run = []
runners.forEach(element =>run.push( element.last_name + ', ' + element.first_name) )
return run
}
